function []=Image_time_slicer_block(prefix)
close all;
...
% --- Save Results ---
imwrite(mosaic_std, fullfile(outputFolder, [prefix, '_Mosaic_Sequential.png']));
imwrite(mosaic_rnd, fullfile(outputFolder, [prefix, '_Mosaic_Random.png']));
